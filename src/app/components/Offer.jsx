...
const Offer = () => {
    return (
        <div className='max-w-5xl lg:max-w-7xl custom_1080:max-w-5xl xl:max-w-6xl custom_1440:max-w-7xl custom_1600:max-w-7xl  mx-auto mt-10 md:mt-20 lg:mt-10' data-aos="fade-up">

            <div className='grid grid-cols-1 lg:grid-cols-4 gap-2 ' >
                {/* <div className='grid grid-cols-1 lg:grid-cols-4 gap-5  mx-auto'> */}

                {/* 1st */}
                <div className="card card-compact items-stretch md:items-center flex-row md:flex-col w-80 md:w-80 lg:w-96 custom_1080:w-[16rem] custom_1440:w-[20rem] custom_1600:w-80 h-full mx-auto text-center lg:text-start gap-5 md:gap-0 mb-5">
                ...
                <div className="card card-compact items-stretch md:items-center flex-row md:flex-col w-80 md:w-80 lg:w-96 custom_1080:w-[16rem] custom_1440:w-[20rem] custom_1600:w-80 h-full mx-auto text-center lg:text-start gap-5 md:gap-0 mb-5">
                    ...
                    <div className="card-body text-start md:text-center">
                        <p className='text-base leading-[1.38rem] text-[#222] '>¿Cuánto dinero estás perdiendo por no <span className='font-bold'>optimizar tu estrategia</span> y no <span className='font-bold'>maximizar el retorno de tu inversión</span>?</p>

                    </div>
                </div>

            </div>
            <p className='text-center my-5 mx-auto text-lg font-bold' >No sigas perdiendo oportunidades.<br className='lg:hidden'/> Nosotros podemos ayudarte.</p>
