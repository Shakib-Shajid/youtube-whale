...
const Premium = () => {
    return (
        <div className='text-center my-20 w-[80%] mx-auto' data-aos="fade-down">
            ...
            <Link href="https://calendly.com/d/cqjr-4dn-xcf/presentacion-analisis-seo" target='_blank'><button className="cta-button rounded-full hover:bg-[#FF9F42]"><IoIosSearch className='inline text-2xl mr-2'/>Solicita tu análisis SEO GRATIS ahora</button></Link>
